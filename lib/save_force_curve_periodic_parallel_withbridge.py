...
#results_path = os.path.expanduser('~/raw_results_modifications/withbridge')
results_path = "/oak/stanford/groups/gratta/sims/results_modified/withbridge"
