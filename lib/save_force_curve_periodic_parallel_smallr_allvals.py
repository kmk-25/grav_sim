...
rbeads = np.array([3.78e-6])
seps = np.arange(20.0e-6, 25.1e-6, 1e-6)
...
#results_path = os.path.expanduser('~/raw_results_final/smallr/allvals')
results_path = "/oak/stanford/groups/gratta/sims/raw_results_3/smallr"
